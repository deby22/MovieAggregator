...
class MovieManagerTestCase(TestCase):
    ...
    def test_ordering_with_start_date(self):
        ...
        total_comments = Movie.objects.top(start_date).values_list('total_comments', flat=True)
    ...
    def test_ordering_with_end_date(self):
        ...
        total_comments = Movie.objects.top(None, end_date).values_list('total_comments', flat=True)
        self.assertEqual(max(list(total_comments)), 5)
    ...
    def test_ordering_with_start_date_and_end_date(self):
        ...
        total_comments = Movie.objects.top(start_date, end_date).values_list('total_comments', flat=True)
        self.assertEqual(max(list(total_comments)), 5)
